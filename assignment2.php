...
$tuition = 7000 ; // input tuition fee here

$commission = ($tuition > 20000) ? ($tuition * .25) : (($tuition > 10000) ? ($tuition * .2) : (($tuition >= 7000) ? ($tuition * .15) : "Invalid"));



echo "Admition Agent Comission is $". $commission."/=";
